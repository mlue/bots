...
#define EGG_AC_ARGS " '--with-tcllib=/usr/lib/x86_64-linux-gnu/libtcl.so' '--with-tclinc=/usr/include/tcl8.6/tcl.h' '--prefix=/home/eggdrop/usr/eggdrop/'"
...
#define PACKAGE_STRING "Eggdrop 1.6.21"
